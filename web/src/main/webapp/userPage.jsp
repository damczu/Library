...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-12">
                    <a href="#borrowBook" class="btn btn-success" data-toggle="modal"><i class="material-icons">book</i> <span>Borrow book</span></a>
                    <a href="#showBook" class="btn btn-success" data-toggle="modal"><i class="material-icons">remove_red_eye</i> <span>Book details</span></a>
                </div>
            </div>
        </div>
...
<!-- Show book modal card-->

<div id="showBook" class="modal fade">
