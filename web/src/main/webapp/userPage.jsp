    ...
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="#borrowBook" class="btn btn-success" data-toggle="modal"><i class="material-icons">book</i>
                        <span>Borrow book</span></a>
                    <a href="#showBook" class="btn btn-success" data-toggle="modal"><i class="material-icons">remove_red_eye</i>
